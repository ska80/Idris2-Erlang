...
-export([
  'nested--2671-872--in--un--compressRights'/4,
  'nested--2671-841--in--un--compressLefts'/4,
  'un--rights'/1,
  'un--rightInjective'/1,
  'un--pushInto'/2,
...
'nested--2671-872--in--un--compressRights'(V0, V1, V2, V3) -> case V3 of [E0 | E1] -> (fun (V4, V5) -> case V4 of {'Idris.Prelude.Types.Right', E2} -> (fun (V6) -> ('nested--2671-872--in--un--compressRights'(V0, V1, ('Idris.Idris2.Data.List1':'un--cons'(V6, V2)), V5)) end(E2)); _ -> [{'Idris.Prelude.Types.Right', ('Idris.Idris2.Data.List1':'un--reverse'(V2))} | ('un--compress'(V3))] end end(E0, E1)); _ -> [{'Idris.Prelude.Types.Right', ('Idris.Idris2.Data.List1':'un--reverse'(V2))} | ('un--compress'(V3))] end.
'nested--2671-841--in--un--compressLefts'(V0, V1, V2, V3) -> case V3 of [E0 | E1] -> (fun (V4, V5) -> case V4 of {'Idris.Prelude.Types.Left', E2} -> (fun (V6) -> ('nested--2671-841--in--un--compressLefts'(V0, V1, ('Idris.Idris2.Data.List1':'un--cons'(V6, V2)), V5)) end(E2)); _ -> [{'Idris.Prelude.Types.Left', ('Idris.Idris2.Data.List1':'un--reverse'(V2))} | ('un--compress'(V3))] end end(E0, E1)); _ -> [{'Idris.Prelude.Types.Left', ('Idris.Idris2.Data.List1':'un--reverse'(V2))} | ('un--compress'(V3))] end.
...
'un--compress'(V0) -> case V0 of [] -> []; [E0 | E1] -> (fun (V1, V2) -> case V1 of {'Idris.Prelude.Types.Left', E2} -> (fun (V3) -> ('nested--2671-841--in--un--compressLefts'(V3, V2, ('Idris.Idris2.Data.List1':'un--singleton'(V3)), V2)) end(E2)); {'Idris.Prelude.Types.Right', E3} -> (fun (V4) -> ('nested--2671-872--in--un--compressRights'(V4, V2, ('Idris.Idris2.Data.List1':'un--singleton'(V4)), V2)) end(E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
