...
-export([
  ...
  'nested--3081-891--in--un--fromHexChars\x{27}'/2,
  'nested--2882-699--in--un--asHex\x{27}'/3,
  'un--leftPad'/3,
  'un--hexDigit'/1,
  'un--fromHexDigit'/1,
  'un--fromHexChars'/1,
...
'with--asHex,asHex\x{27}-708'(V0, V1, V2, V3) -> case V2 of {'Idris.Data.Primitives.Views.IntV.DivBy', E0, E1, E2} -> (fun (V4, V5, V6) -> ('nested--2882-699--in--un--asHex\x{27}'(V0, V4, [('un--hexDigit'(V5)) | V3])) end(E0, E1, E2)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'nested--3081-891--in--un--fromHexChars\x{27}'(V0, V1) -> case V1 of [] -> {'Idris.Prelude.Types.Just', 0}; [E0 | E1] -> (fun (V2, V3) -> ('Idris.Idris2.Prelude.Types':'dn--un-->>=_Monad_Maybe'(('un--fromHexDigit'(('Idris.Idris2.Prelude.Types':'un--toLower'(V2)))), fun (V4) -> ('Idris.Idris2.Prelude.Types':'dn--un-->>=_Monad_Maybe'(('nested--3081-891--in--un--fromHexChars\x{27}'((V0 * 16), V3)), fun (V5) -> ('Idris.Idris2.Prelude.Types':'dn--un--pure_Applicative_Maybe'(((('Idris.Idris2.Prelude.Cast':'dn--un--cast_Cast_Int_Integer'(V4)) * V0) + V5))) end)) end)) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'nested--2882-699--in--un--asHex\x{27}'(V0, V1, V2) -> case V1 of 0 -> V2; _ -> ('with--asHex,asHex\x{27}-708'(V1, V1, ('Idris.Idris2.Data.Primitives.Views.IntV':'un--divides'(V1, 16)), V2)) end.
...
'un--fromHexChars'(V0) -> ('nested--3081-891--in--un--fromHexChars\x{27}'(1, V0)).
'un--fromHex'(V0) -> ('un--fromHexChars'(('Idris.Idris2.Prelude.Types':'un--fastUnpack'(V0)))).
'un--asHex'(V0) -> case ('Idris.Idris2.Prelude.EqOrd':'dn--un-->_Ord_Int'(V0, 0)) of 1 -> ('Idris.Idris2.Prelude.Types':'un--fastPack'(('nested--2882-699--in--un--asHex\x{27}'(V0, V0, [])))); 0 -> <<"0"/utf8>>; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
