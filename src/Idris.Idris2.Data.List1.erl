...
-export([
  ...
  'nested--3520-1947--in--un--zipWith3\x{27}'/10,
  'nested--3512-1906--in--un--zipWith\x{27}'/7,
  'nested--3539-2150--in--un--unzipWith3\x{27}'/4,
  'nested--3531-1995--in--un--unzipWith\x{27}'/4,
  'nested--2567-848--in--un--loop'/6,
  'nested--2546-825--in--un--loop'/4,
  'nested--2527-809--in--un--loop'/4,
  'nested--2684-941--in--un--go'/4,
...
'case--unzipWith-2081'(V0, V1, V2, V3) -> case V3 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V4, V5) -> case ('nested--3531-1995--in--un--unzipWith\x{27}'(V0, V1, V2, V1)) of {'Idris.Builtin.MkPair', E2, E3} -> (fun (V6, V7) -> {'Idris.Builtin.MkPair', {'Idris.Data.List1.:::', V4, V6}, {'Idris.Data.List1.:::', V5, V7}} end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'case--unzipWith,unzipWith\x{27}-2011'(V0, V1, V2, V3, V4, V5) -> case V5 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V6, V7) -> case ('nested--3531-1995--in--un--unzipWith\x{27}'(V0, V1, V2, V4)) of {'Idris.Builtin.MkPair', E2, E3} -> (fun (V8, V9) -> {'Idris.Builtin.MkPair', [V6 | V8], [V7 | V9]} end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'nested--3520-1947--in--un--zipWith3\x{27}'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9) -> case V7 of [] -> []; _ -> case V8 of [] -> []; _ -> case V9 of [] -> []; _ -> case V7 of [E0 | E1] -> (fun (V10, V11) -> case V8 of [E2 | E3] -> (fun (V12, V13) -> case V9 of [E4 | E5] -> (fun (V14, V15) -> [(((V6(V10))(V12))(V14)) | ('nested--3520-1947--in--un--zipWith3\x{27}'(V0, V1, V2, V3, V4, V5, V6, V11, V13, V15))] end(E4, E5)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end end end.
'nested--3512-1906--in--un--zipWith\x{27}'(V0, V1, V2, V3, V4, V5, V6) -> case V5 of [] -> []; _ -> case V6 of [] -> []; _ -> case V5 of [E0 | E1] -> (fun (V7, V8) -> case V6 of [E2 | E3] -> (fun (V9, V10) -> [((V4(V7))(V9)) | ('nested--3512-1906--in--un--zipWith\x{27}'(V0, V1, V2, V3, V4, V8, V10))] end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end end.
'nested--3539-2150--in--un--unzipWith3\x{27}'(V0, V1, V2, V3) -> case V3 of [] -> {'Idris.Builtin.MkPair', [], {'Idris.Builtin.MkPair', [], []}}; [E0 | E1] -> (fun (V4, V5) -> case (V2(V4)) of {'Idris.Builtin.MkPair', E2, E3} -> (fun (V6, V7) -> case V7 of {'Idris.Builtin.MkPair', E4, E5} -> (fun (V8, V9) -> case ('nested--3539-2150--in--un--unzipWith3\x{27}'(V0, V1, V2, V5)) of {'Idris.Builtin.MkPair', E6, E7} -> (fun (V10, V11) -> case V11 of {'Idris.Builtin.MkPair', E8, E9} -> (fun (V12, V13) -> {'Idris.Builtin.MkPair', [V6 | V10], {'Idris.Builtin.MkPair', [V8 | V12], [V9 | V13]}} end(E8, E9)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E6, E7)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E4, E5)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'nested--3531-1995--in--un--unzipWith\x{27}'(V0, V1, V2, V3) -> case V3 of [] -> {'Idris.Builtin.MkPair', [], []}; [E0 | E1] -> (fun (V4, V5) -> case (V2(V4)) of {'Idris.Builtin.MkPair', E2, E3} -> (fun (V6, V7) -> case ('nested--3531-1995--in--un--unzipWith\x{27}'(V0, V1, V2, V5)) of {'Idris.Builtin.MkPair', E4, E5} -> (fun (V8, V9) -> {'Idris.Builtin.MkPair', [V6 | V8], [V7 | V9]} end(E4, E5)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'nested--2567-848--in--un--loop'(V0, V1, V2, V3, V4, V5) -> case V5 of [] -> (V2(V4)); [E0 | E1] -> (fun (V6, V7) -> ((V3(V4))(('nested--2567-848--in--un--loop'(V0, V1, V2, V3, V6, V7)))) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'nested--2546-825--in--un--loop'(V0, V1, V2, V3) -> case V3 of [] -> []; [E0 | E1] -> (fun (V4, V5) -> [V2 | ('nested--2546-825--in--un--loop'(V0, V1, V4, V5))] end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'nested--2527-809--in--un--loop'(V0, V1, V2, V3) -> case V3 of [] -> V2; [E0 | E1] -> (fun (V4, V5) -> ('nested--2527-809--in--un--loop'(V0, V1, V4, V5)) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'nested--2684-941--in--un--go'(V0, V1, V2, V3) -> case V3 of [] -> {'Idris.Builtin.MkPair', [], V2}; [E0 | E1] -> (fun (V4, V5) -> case ('nested--2684-941--in--un--go'(V0, V1, V4, V5)) of {'Idris.Builtin.MkPair', E2, E3} -> (fun (V6, V7) -> {'Idris.Builtin.MkPair', [V2 | V6], V7} end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'dn--un--zip_Zippable_List1'(V0, V1) -> ('dn--un--zipWith_Zippable_List1'(fun (V2) -> fun (V3) -> {'Idris.Builtin.MkPair', V2, V3} end end, V0, V1)).
'dn--un--zipWith_Zippable_List1'(V0, V1, V2) -> case V1 of {'Idris.Data.List1.:::', E0, E1} -> (fun (V3, V4) -> case V2 of {'Idris.Data.List1.:::', E2, E3} -> (fun (V5, V6) -> {'Idris.Data.List1.:::', ((V0(V3))(V5)), ('nested--3512-1906--in--un--zipWith\x{27}'(V3, V4, V5, V6, V0, V4, V6))} end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'dn--un--zipWith3_Zippable_List1'(V0, V1, V2, V3) -> case V1 of {'Idris.Data.List1.:::', E0, E1} -> (fun (V4, V5) -> case V2 of {'Idris.Data.List1.:::', E2, E3} -> (fun (V6, V7) -> case V3 of {'Idris.Data.List1.:::', E4, E5} -> (fun (V8, V9) -> {'Idris.Data.List1.:::', (((V0(V4))(V6))(V8)), ('nested--3520-1947--in--un--zipWith3\x{27}'(V4, V5, V6, V7, V8, V9, V0, V5, V7, V9))} end(E4, E5)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'un--unsnoc'(V0) -> case V0 of {'Idris.Data.List1.:::', E0, E1} -> (fun (V1, V2) -> ('nested--2684-941--in--un--go'(V1, V2, V1, V2)) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'un--last'(V0) -> case V0 of {'Idris.Data.List1.:::', E0, E1} -> (fun (V1, V2) -> ('nested--2527-809--in--un--loop'(V1, V2, V1, V2)) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'un--init'(V0) -> case V0 of {'Idris.Data.List1.:::', E0, E1} -> (fun (V1, V2) -> ('nested--2546-825--in--un--loop'(V1, V2, V1, V2)) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'un--foldr1By'(V0, V1, V2) -> case V2 of {'Idris.Data.List1.:::', E0, E1} -> (fun (V3, V4) -> ('nested--2567-848--in--un--loop'(V3, V4, V1, V0, V3, V4)) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'un--appendl'(V0, V1) -> case V0 of {'Idris.Data.List1.:::', E0, E1} -> (fun (V2, V3) -> {'Idris.Data.List1.:::', V2, ('Idris.Idris2.Prelude.Types.List':'un--tailRecAppend'(V3, V1))} end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
