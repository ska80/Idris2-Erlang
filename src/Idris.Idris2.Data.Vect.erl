...
-export([
  'with--overLength-5316'/5,
  'with--exactLength-5291'/5,
  'with--splitAt-3597'/6,
  'with--with block in nubBy,nubBy\x{27}-3374'/9,
  'with--nubBy,nubBy\x{27}-3346'/9,
  'with--decEq-1743'/9,
  'case--case block in unzipWith3-4571'/7,
  'case--unzipWith3-4529'/4,
  'case--case block in unzipWith-4448'/6,
  'case--unzipWith-4413'/4,
  'case--catMaybes-3964'/3,
  'case--case block in partition-3694'/8,
  'case--partition-3664'/4,
  'case--case block in deleteBy-3495'/9,
  'case--deleteBy-3470'/7,
  'case--case block in filter-3246'/6,
  'case--filter-3222'/4,
  'case--findIndices-3085'/5,
  'case--findIndex-3011'/4,
  'case--find-2954'/4,
  'case--lookupBy-2810'/6,
  'case--compare-2082'/6,
  'case--max-1970'/4,
  'case--min-1935'/4,
  'nested--6342-3310--in--un--nubBy\x{27}'/3,
  'nested--4457-1496--in--un--intersperse\x{27}'/5,
  'nested--4411-1435--in--un--go'/3,
...
'with--overLength-5316'(V0, V1, V2, V3, V4) -> case V2 of {'Idris.Data.Nat.CmpLT', E0} -> (fun (V5) -> {'Idris.Prelude.Types.Nothing'} end(E0)); {'Idris.Data.Nat.CmpEQ'} -> (fun () -> {'Idris.Prelude.Types.Just', {'Idris.Builtin.DPair.MkDPair', 0, V4}} end()); {'Idris.Data.Nat.CmpGT', E1} -> (fun (V6) -> {'Idris.Prelude.Types.Just', {'Idris.Builtin.DPair.MkDPair', (1 + V6), V4}} end(E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'with--exactLength-5291'(V0, V1, V2, V3, V4) -> case V2 of {'Idris.Prelude.Types.Yes', E0} -> (fun (V5) -> case V5 of 0 -> {'Idris.Prelude.Types.Just', V4}; _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0)); {'Idris.Prelude.Types.No', E1} -> (fun (V6) -> {'Idris.Prelude.Types.Nothing'} end(E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'with--splitAt-3597'(V0, V1, V2, V3, V4, V5) -> case V4 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V6, V7) -> {'Idris.Builtin.MkPair', {'Idris.Data.Vect.::', V5, V6}, V7} end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'with--with block in nubBy,nubBy\x{27}-3374'(V0, V1, V2, V3, V4, V5, V6, V7, V8) -> case V8 of {'Idris.Builtin.DPair.MkDPair', E0, E1} -> (fun (V9, V10) -> {'Idris.Builtin.DPair.MkDPair', (1 + V9), {'Idris.Data.Vect.::', V7, V10}} end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'with--nubBy,nubBy\x{27}-3346'(V0, V1, V2, V3, V4, V5, V6, V7, V8) -> case V6 of 1 -> ('nested--6342-3310--in--un--nubBy\x{27}'(V5, V4, V8)); 0 -> ('with--with block in nubBy,nubBy\x{27}-3374'('erased', 'erased', 'erased', V8, 'erased', V5, V4, V3, ('nested--6342-3310--in--un--nubBy\x{27}'({'Idris.Data.Vect.::', V3, V5}, V4, V8)))); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'with--decEq-1743'(V0, V1, V2, V3, V4, V5, V6, V7, V8) -> case V7 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V9, V10) -> case V9 of {'Idris.Prelude.Types.Yes', E3} -> (fun (V11) -> case V11 of 0 -> case V10 of {'Idris.Prelude.Types.Yes', E6} -> (fun (V12) -> case V12 of 0 -> {'Idris.Prelude.Types.Yes', 0}; _ -> case V10 of {'Idris.Prelude.Types.No', E7} -> (fun (V13) -> {'Idris.Prelude.Types.No', fun (V14) -> (V13(('Idris.Idris2.Builtin':'un--snd'(('un--vectInjective'(V14)))))) end} end(E7)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end end(E6)); _ -> case V10 of {'Idris.Prelude.Types.No', E5} -> (fun (V15) -> {'Idris.Prelude.Types.No', fun (V16) -> (V15(('Idris.Idris2.Builtin':'un--snd'(('un--vectInjective'(V16)))))) end} end(E5)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end; _ -> case V10 of {'Idris.Prelude.Types.No', E4} -> (fun (V17) -> {'Idris.Prelude.Types.No', fun (V18) -> (V17(('Idris.Idris2.Builtin':'un--snd'(('un--vectInjective'(V18)))))) end} end(E4)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end end(E3)); {'Idris.Prelude.Types.No', E8} -> (fun (V19) -> {'Idris.Prelude.Types.No', fun (V20) -> (V19(('Idris.Idris2.Builtin':'un--fst'(('un--vectInjective'(V20)))))) end} end(E8)); _ -> case V10 of {'Idris.Prelude.Types.No', E2} -> (fun (V21) -> {'Idris.Prelude.Types.No', fun (V22) -> (V21(('Idris.Idris2.Builtin':'un--snd'(('un--vectInjective'(V22)))))) end} end(E2)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--case block in unzipWith3-4571'(V0, V1, V2, V3, V4, V5, V6) -> case V6 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V7, V8) -> case V8 of {'Idris.Builtin.MkPair', E2, E3} -> (fun (V9, V10) -> {'Idris.Builtin.MkPair', {'Idris.Data.Vect.::', V3, V7}, {'Idris.Builtin.MkPair', {'Idris.Data.Vect.::', V4, V9}, {'Idris.Data.Vect.::', V5, V10}}} end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--unzipWith3-4529'(V0, V1, V2, V3) -> case V3 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V4, V5) -> case V5 of {'Idris.Builtin.MkPair', E2, E3} -> (fun (V6, V7) -> case ('dn--un--unzipWith3_Zippable_(Vect $k)'(V2, V1)) of {'Idris.Builtin.MkPair', E4, E5} -> (fun (V8, V9) -> case V9 of {'Idris.Builtin.MkPair', E6, E7} -> (fun (V10, V11) -> {'Idris.Builtin.MkPair', {'Idris.Data.Vect.::', V4, V8}, {'Idris.Builtin.MkPair', {'Idris.Data.Vect.::', V6, V10}, {'Idris.Data.Vect.::', V7, V11}}} end(E6, E7)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E4, E5)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--case block in unzipWith-4448'(V0, V1, V2, V3, V4, V5) -> case V5 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V6, V7) -> {'Idris.Builtin.MkPair', {'Idris.Data.Vect.::', V3, V6}, {'Idris.Data.Vect.::', V4, V7}} end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--unzipWith-4413'(V0, V1, V2, V3) -> case V3 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V4, V5) -> case ('dn--un--unzipWith_Zippable_(Vect $k)'(V2, V1)) of {'Idris.Builtin.MkPair', E2, E3} -> (fun (V6, V7) -> {'Idris.Builtin.MkPair', {'Idris.Data.Vect.::', V4, V6}, {'Idris.Data.Vect.::', V5, V7}} end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--catMaybes-3964'(V0, V1, V2) -> case V2 of {'Idris.Builtin.DPair.MkDPair', E0, E1} -> (fun (V3, V4) -> {'Idris.Builtin.DPair.MkDPair', (1 + V3), {'Idris.Data.Vect.::', V0, V4}} end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--case block in partition-3694'(V0, V1, V2, V3, V4, V5, V6, V7) -> case V7 of 1 -> {'Idris.Builtin.MkPair', {'Idris.Builtin.DPair.MkDPair', (1 + V3), {'Idris.Data.Vect.::', V2, V4}}, {'Idris.Builtin.DPair.MkDPair', V5, V6}}; 0 -> {'Idris.Builtin.MkPair', {'Idris.Builtin.DPair.MkDPair', V3, V4}, {'Idris.Builtin.DPair.MkDPair', (1 + V5), {'Idris.Data.Vect.::', V2, V6}}}; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--partition-3664'(V0, V1, V2, V3) -> case V3 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V4, V5) -> case V4 of {'Idris.Builtin.DPair.MkDPair', E2, E3} -> (fun (V6, V7) -> case V5 of {'Idris.Builtin.DPair.MkDPair', E4, E5} -> (fun (V8, V9) -> case (V2(V0)) of 1 -> {'Idris.Builtin.MkPair', {'Idris.Builtin.DPair.MkDPair', (1 + V6), {'Idris.Data.Vect.::', V0, V7}}, {'Idris.Builtin.DPair.MkDPair', V8, V9}}; 0 -> {'Idris.Builtin.MkPair', {'Idris.Builtin.DPair.MkDPair', V6, V7}, {'Idris.Builtin.DPair.MkDPair', (1 + V8), {'Idris.Data.Vect.::', V0, V9}}}; _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E4, E5)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--case block in deleteBy-3495'(V0, V1, V2, V3, V4, V5, V6, V7, V8) -> case V8 of 1 -> {'Idris.Builtin.DPair.MkDPair', V0, V1}; 0 -> {'Idris.Builtin.DPair.MkDPair', (1 + V6), {'Idris.Data.Vect.::', V4, V7}}; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--deleteBy-3470'(V0, V1, V2, V3, V4, V5, V6) -> case V6 of {'Idris.Builtin.DPair.MkDPair', E0, E1} -> (fun (V7, V8) -> case ((V4(V1))(V2)) of 1 -> {'Idris.Builtin.DPair.MkDPair', V0, V3}; 0 -> {'Idris.Builtin.DPair.MkDPair', (1 + V7), {'Idris.Data.Vect.::', V2, V8}}; _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--case block in filter-3246'(V0, V1, V2, V3, V4, V5) -> case V5 of 1 -> {'Idris.Builtin.DPair.MkDPair', (1 + V2), {'Idris.Data.Vect.::', V3, V4}}; 0 -> {'Idris.Builtin.DPair.MkDPair', V2, V4}; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--filter-3222'(V0, V1, V2, V3) -> case V3 of {'Idris.Builtin.DPair.MkDPair', E0, E1} -> (fun (V4, V5) -> case (V2(V0)) of 1 -> {'Idris.Builtin.DPair.MkDPair', (1 + V4), {'Idris.Data.Vect.::', V0, V5}}; 0 -> {'Idris.Builtin.DPair.MkDPair', V4, V5}; _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--findIndices-3085'(V0, V1, V2, V3, V4) -> case V4 of 1 -> [0 | V3]; 0 -> V3; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--findIndex-3011'(V0, V1, V2, V3) -> case V3 of 1 -> {'Idris.Prelude.Types.Just', 0}; 0 -> ('Idris.Idris2.Prelude.Interfaces':'un--<$>'(fun (V4) -> fun (V5) -> fun (V6) -> fun (V7) -> ('Idris.Idris2.Prelude.Types':'dn--un--map_Functor_Maybe'(V6, V7)) end end end end, fun (V8) -> (1 + V8) end, ('un--findIndex'(V2, V1)))); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--find-2954'(V0, V1, V2, V3) -> case V3 of 1 -> {'Idris.Prelude.Types.Just', V0}; 0 -> ('un--find'(V2, V1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--lookupBy-2810'(V0, V1, V2, V3, V4, V5) -> case V5 of 1 -> {'Idris.Prelude.Types.Just', V2}; 0 -> ('un--lookupBy'(V4, V0, V3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--compare-2082'(V0, V1, V2, V3, V4, V5) -> case V5 of 1 -> ('dn--un--compare_Ord_((Vect $len) $elem)'(V0, V2, V4)); _ -> V5 end.
'case--max-1970'(V0, V1, V2, V3) -> case V3 of 1 -> V2; 0 -> V1; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--min-1935'(V0, V1, V2, V3) -> case V3 of 1 -> V2; 0 -> V1; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'nested--6342-3310--in--un--nubBy\x{27}'(V0, V1, V2) -> case V2 of {'Idris.Data.Vect.Nil'} -> (fun () -> {'Idris.Builtin.DPair.MkDPair', 0, {'Idris.Data.Vect.Nil'}} end()); {'Idris.Data.Vect.::', E0, E1} -> (fun (V3, V4) -> ('with--nubBy,nubBy\x{27}-3346'('erased', 'erased', 'erased', V3, V1, V0, ('un--elemBy'(V1, V3, V0)), 'erased', V4)) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'nested--4457-1496--in--un--intersperse\x{27}'(V0, V1, V2, V3, V4) -> case V4 of {'Idris.Data.Vect.Nil'} -> (fun () -> {'Idris.Data.Vect.Nil'} end()); {'Idris.Data.Vect.::', E0, E1} -> (fun (V5, V6) -> {'Idris.Data.Vect.::', V3, {'Idris.Data.Vect.::', V5, ('nested--4457-1496--in--un--intersperse\x{27}'(V0, V1, V2, V3, V6))}} end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'nested--4411-1435--in--un--go'(V0, V1, V2) -> case V2 of {'Idris.Data.Vect.Nil'} -> (fun () -> V1 end()); {'Idris.Data.Vect.::', E0, E1} -> (fun (V3, V4) -> ('nested--4411-1435--in--un--go'(V0, {'Idris.Data.Vect.::', V3, V1}, V4)) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'dn--un--decEq_DecEq_((Vect $n) $a)'(V0, V1, V2) -> case V1 of {'Idris.Data.Vect.Nil'} -> (fun () -> case V2 of {'Idris.Data.Vect.Nil'} -> (fun () -> {'Idris.Prelude.Types.Yes', 0} end()); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end()); {'Idris.Data.Vect.::', E0, E1} -> (fun (V3, V4) -> case V2 of {'Idris.Data.Vect.::', E2, E3} -> (fun (V5, V6) -> ('with--decEq-1743'('erased', V0, 'erased', V3, V4, V5, V6, {'Idris.Builtin.MkPair', ((V0(V3))(V5)), ('dn--un--decEq_DecEq_((Vect $n) $a)'(V0, V4, V6))}, 'erased')) end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'dn--un--compare_Ord_((Vect $len) $elem)'(V0, V1, V2) -> case V1 of {'Idris.Data.Vect.Nil'} -> (fun () -> case V2 of {'Idris.Data.Vect.Nil'} -> (fun () -> 1 end()); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end()); {'Idris.Data.Vect.::', E0, E1} -> (fun (V3, V4) -> case V2 of {'Idris.Data.Vect.::', E2, E3} -> (fun (V5, V6) -> ('case--compare-2082'(V0, V3, V4, V5, V6, case V0 of {'Idris.Prelude.EqOrd.MkOrd', E4, E5, E6, E7, E8, E9, E10, E11} -> (fun (V7, V8, V9, V10, V11, V12, V13, V14) -> ((V8(V3))(V5)) end(E4, E5, E6, E7, E8, E9, E10, E11)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end)) end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'un--splitAt'(V0, V1) -> case V0 of 0 -> {'Idris.Builtin.MkPair', {'Idris.Data.Vect.Nil'}, V1}; _ -> begin (V2 = (V0 - 1)), case V1 of {'Idris.Data.Vect.::', E0, E1} -> (fun (V3, V4) -> ('with--splitAt-3597'('erased', 'erased', V2, V4, ('un--splitAt'(V2, V4)), V3)) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end end.
...
'un--reverse'(V0) -> ('nested--4411-1435--in--un--go'(V0, {'Idris.Data.Vect.Nil'}, V0)).
...
'un--overLength'(V0, V1, V2) -> ('with--overLength-5316'(V0, V1, ('Idris.Idris2.Data.Nat':'un--cmp'(V0, V1)), 'erased', V2)).
'un--nubBy'(V0, V1) -> ('nested--6342-3310--in--un--nubBy\x{27}'({'Idris.Data.Vect.Nil'}, V0, V1)).
...
'un--intersperse'(V0, V1) -> case V1 of {'Idris.Data.Vect.Nil'} -> (fun () -> {'Idris.Data.Vect.Nil'} end()); {'Idris.Data.Vect.::', E0, E1} -> (fun (V2, V3) -> {'Idris.Data.Vect.::', V2, ('nested--4457-1496--in--un--intersperse\x{27}'(V0, V2, V3, V0, V3))} end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'un--exactLength'(V0, V1, V2) -> ('with--exactLength-5291'(V0, V1, ('Idris.Idris2.Decidable.Equality':'dn--un--decEq_DecEq_Nat'(V0, V1)), 'erased', V2)).
