...
'nested--3273-959--in--un--acc'(V0, V1, V2, V3, V4) -> case V2 of 0 -> ('erlang':'throw'("Nat case not covered")); _ -> begin (V5 = (V2 - 1)), case V4 of 0 -> ('erlang':'throw'("Nat case not covered")); _ -> begin (V6 = (V4 - 1)), fun (V7) -> fun (V8) -> ('nested--3273-959--in--un--acc'(V0, V1, V5, V7, ('Idris.Idris2.Data.Nat':'dn--un--transitive_Transitive_Nat_LTE'((1 + (V0(V7))), (V0(V3)), V5, V8, V6)))) end end end end end end.
...
'un--sizeAccessible'(V0, V1, V2, V3) -> ('nested--3273-959--in--un--acc'(V0, V1, (V0(V1)), V2, V3)).
'un--size'(V0, V1) -> (V0(V1)).
