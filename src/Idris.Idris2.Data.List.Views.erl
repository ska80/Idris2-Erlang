...
'un--snocListHelp'(V0, V1, V2) -> case V2 of [] -> V1; [E0 | E1] -> (fun (V3, V4) -> ('un--snocListHelp'(('Idris.Idris2.Prelude.Types.List':'un--tailRecAppend'(V0, [V3 | []])), {'Idris.Data.List.Views.Snoc', V3, V0, V1}, V4)) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
