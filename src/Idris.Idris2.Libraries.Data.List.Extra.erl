...
'case--diffBy-2875'(V0, V1, V2, V3, V4) -> case V4 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V5, V6) -> case V6 of {'Idris.Builtin.MkPair', E2, E3} -> (fun (V7, V8) -> begin (V9 = ('Idris.Idris2.Prelude.Types.List':'un--tailRecAppend'(V5, V8))), case V7 of {'Idris.Prelude.Types.Just', E4} -> (fun (V10) -> ('un--diffBy'(V3, V1, V9)) end(E4)); {'Idris.Prelude.Types.Nothing'} -> (fun () -> [V0 | ('un--diffBy'(V3, V1, V9))] end()); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'un--groupBy'(V0, V1) -> case V1 of [] -> []; [E0 | E1] -> (fun (V2, V3) -> case ('nested--3474-3054--in--un--go'(V2, V3, V0, V2, V3)) of {'Idris.Builtin.MkPair', E2, E3} -> (fun (V4, V5) -> [V4 | V5] end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
