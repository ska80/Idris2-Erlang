...
-export([
  'nested--2934-927--in--un--nSpaces'/1,
  'nested--2934-928--in--un--go'/2,
  'nested--2911-902--in--un--go'/1,
...
'nested--2934-927--in--un--nSpaces'(V0) -> ('Idris.Idris2.Prelude.Types':'un--fastPack'(('Idris.Idris2.Data.List':'un--replicate'(V0, $ )))).
'nested--2934-928--in--un--go'(V0, V1) -> case V1 of {'Idris.Compiler.ES.Doc.Nil'} -> (fun () -> [] end()); {'Idris.Compiler.ES.Doc.LineBreak'} -> (fun () -> [<<"\x{a}"/utf8>> | [V0 | []]] end()); {'Idris.Compiler.ES.Doc.SoftSpace'} -> (fun () -> [<<" "/utf8>> | []] end()); {'Idris.Compiler.ES.Doc.Text', E0} -> (fun (V2) -> [V2 | []] end(E0)); {'Idris.Compiler.ES.Doc.Nest', E1, E2} -> (fun (V3, V4) -> ('nested--2934-928--in--un--go'(('Idris.Idris2.Prelude.Types.String':'un--++'(V0, ('nested--2934-927--in--un--nSpaces'(V3)))), V4)) end(E1, E2)); {'Idris.Compiler.ES.Doc.Seq', E3, E4} -> (fun (V5, V6) -> ('Idris.Idris2.Prelude.Types.List':'un--tailRecAppend'(('nested--2934-928--in--un--go'(V0, V5)), ('nested--2934-928--in--un--go'(V0, V6)))) end(E3, E4)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'nested--2911-902--in--un--go'(V0) -> case V0 of {'Idris.Compiler.ES.Doc.Nil'} -> (fun () -> [] end()); {'Idris.Compiler.ES.Doc.LineBreak'} -> (fun () -> [] end()); {'Idris.Compiler.ES.Doc.SoftSpace'} -> (fun () -> [] end()); {'Idris.Compiler.ES.Doc.Text', E0} -> (fun (V1) -> [V1 | []] end(E0)); {'Idris.Compiler.ES.Doc.Nest', E1, E2} -> (fun (V2, V3) -> ('nested--2911-902--in--un--go'(V3)) end(E1, E2)); {'Idris.Compiler.ES.Doc.Seq', E3, E4} -> (fun (V4, V5) -> ('Idris.Idris2.Prelude.Types.List':'un--tailRecAppend'(('nested--2911-902--in--un--go'(V4)), ('nested--2911-902--in--un--go'(V5)))) end(E3, E4)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'un--pretty'(V0) -> ('Idris.Idris2.Prelude.Types':'un--fastConcat'(('nested--2934-928--in--un--go'(<<""/utf8>>, V0)))).
...
'un--compact'(V0) -> ('Idris.Idris2.Prelude.Types':'un--fastConcat'(('nested--2911-902--in--un--go'(V0)))).
