...
'case--constructorName-1953'(V0, V1, V2) -> case V2 of {'Idris.Core.Name.UN', E0} -> (fun (V3) -> case V3 of {'Idris.Core.Name.Basic', E1} -> (fun (V4) -> V4 end(E1)); _ -> ('un--genName'(V2)) end end(E0)); _ -> ('un--genName'(V2)) end.
...
'un--genName'(V0) -> case V0 of {'Idris.Core.Name.NS', E0, E1} -> (fun (V1, V2) -> ('Idris.Idris2.Prelude.Types.String':'un--++'(<<"ns--"/utf8>>, ('Idris.Idris2.Prelude.Types.String':'un--++'(('Idris.Idris2.Core.Name.Namespace':'dn--un--show_Show_Namespace'(V1)), ('Idris.Idris2.Prelude.Types.String':'un--++'(<<"--"/utf8>>, ('un--genName'(V2)))))))) end(E0, E1)); {'Idris.Core.Name.UN', E2} -> (fun (V3) -> ('Idris.Idris2.Prelude.Types.String':'un--++'(<<"un--"/utf8>>, ('Idris.Idris2.Core.Name':'dn--un--show_Show_UserName'(V3)))) end(E2)); {'Idris.Core.Name.MN', E3, E4} -> (fun (V4, V5) -> ('Idris.Idris2.Prelude.Types.String':'un--++'(<<"mn--"/utf8>>, ('Idris.Idris2.Prelude.Types.String':'un--++'(V4, ('Idris.Idris2.Prelude.Types.String':'un--++'(<<"-"/utf8>>, ('Idris.Idris2.Prelude.Show':'dn--un--show_Show_Int'(V5)))))))) end(E3, E4)); {'Idris.Core.Name.PV', E5, E6} -> (fun (V6, V7) -> ('Idris.Idris2.Prelude.Types.String':'un--++'(<<"pat--"/utf8>>, ('un--genName'(V6)))) end(E5, E6)); {'Idris.Core.Name.DN', E7, E8} -> (fun (V8, V9) -> ('Idris.Idris2.Prelude.Types.String':'un--++'(<<"dn--"/utf8>>, ('un--genName'(V9)))) end(E7, E8)); {'Idris.Core.Name.Nested', E9, E10} -> (fun (V10, V11) -> case V10 of {'Idris.Builtin.MkPair', E11, E12} -> (fun (V12, V13) -> ('Idris.Idris2.Prelude.Types.String':'un--++'(<<"nested--"/utf8>>, ('Idris.Idris2.Prelude.Types.String':'un--++'(('Idris.Idris2.Prelude.Show':'dn--un--show_Show_Int'(V12)), ('Idris.Idris2.Prelude.Types.String':'un--++'(<<"-"/utf8>>, ('Idris.Idris2.Prelude.Types.String':'un--++'(('Idris.Idris2.Prelude.Show':'dn--un--show_Show_Int'(V13)), ('Idris.Idris2.Prelude.Types.String':'un--++'(<<"--in--"/utf8>>, ('un--genName'(V11)))))))))))) end(E11, E12)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E9, E10)); {'Idris.Core.Name.CaseBlock', E13, E14} -> (fun (V14, V15) -> ('Idris.Idris2.Prelude.Types.String':'un--++'(<<"case--"/utf8>>, ('Idris.Idris2.Prelude.Types.String':'un--++'(V14, ('Idris.Idris2.Prelude.Types.String':'un--++'(<<"-"/utf8>>, ('Idris.Idris2.Prelude.Show':'dn--un--show_Show_Int'(V15)))))))) end(E13, E14)); {'Idris.Core.Name.WithBlock', E15, E16} -> (fun (V16, V17) -> ('Idris.Idris2.Prelude.Types.String':'un--++'(<<"with--"/utf8>>, ('Idris.Idris2.Prelude.Types.String':'un--++'(V16, ('Idris.Idris2.Prelude.Types.String':'un--++'(<<"-"/utf8>>, ('Idris.Idris2.Prelude.Show':'dn--un--show_Show_Int'(V17)))))))) end(E15, E16)); {'Idris.Core.Name.Resolved', E17} -> (fun (V18) -> ('Idris.Idris2.Prelude.Types.String':'un--++'(<<"fn--"/utf8>>, ('Idris.Idris2.Prelude.Show':'dn--un--show_Show_Int'(V18)))) end(E17)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
