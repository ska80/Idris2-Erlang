...
-export([
  'with--inBounds-728'/5,
  'case--groupBy-3666'/4,
  'case--case block in groupBy,go-3602'/9,
  'case--groupBy,go-3576'/7,
  'case--mapMaybe-3154'/4,
  'case--case block in unzipWith3-2610'/7,
  'case--unzipWith3-2573'/4,
  'case--case block in unzipWith-2502'/6,
  'case--unzipWith-2472'/4,
  'case--replaceWhen-2024'/5,
  'case--tails-1979'/1,
  'case--inits-1950'/1,
  'case--case block in partition-1897'/6,
  'case--partition-1879'/4,
  'case--splitAt-1833'/4,
  'case--split-1767'/3,
  'case--case block in span-1703'/4,
  'case--span-1686'/4,
  'case--case block in spanBy-1637'/5,
  'case--spanBy-1594'/4,
  ...
  'nested--6096-3513--in--un--spreadHeads'/4,
  'nested--5925-3336--in--un--splitRec'/5,
  'nested--5925-3337--in--un--split'/3,
  'nested--3900-1352--in--un--nubBy\x{27}'/3,
  'nested--3737-1188--in--un--h'/3,
  'nested--6140-3558--in--un--go'/5,
...
'case--groupBy-3666'(V0, V1, V2, V3) -> case V3 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V4, V5) -> [V4 | V5] end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--case block in groupBy,go-3602'(V0, V1, V2, V3, V4, V5, V6, V7, V8) -> case V8 of 1 -> {'Idris.Builtin.MkPair', ('Idris.Idris2.Data.List1':'un--cons'(V3, V6)), V7}; 0 -> {'Idris.Builtin.MkPair', ('Idris.Idris2.Data.List1':'un--singleton'(V3)), [V6 | V7]}; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--groupBy,go-3576'(V0, V1, V2, V3, V4, V5, V6) -> case V6 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V7, V8) -> case ((V2(V5))(V3)) of 1 -> {'Idris.Builtin.MkPair', ('Idris.Idris2.Data.List1':'un--cons'(V5, V7)), V8}; 0 -> {'Idris.Builtin.MkPair', ('Idris.Idris2.Data.List1':'un--singleton'(V5)), [V7 | V8]}; _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--mapMaybe-3154'(V0, V1, V2, V3) -> case V3 of {'Idris.Prelude.Types.Nothing'} -> (fun () -> ('un--mapMaybe'(V2, V1)) end()); {'Idris.Prelude.Types.Just', E0} -> (fun (V4) -> [V4 | ('un--mapMaybe'(V2, V1))] end(E0)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--case block in unzipWith3-2610'(V0, V1, V2, V3, V4, V5, V6) -> case V6 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V7, V8) -> case V8 of {'Idris.Builtin.MkPair', E2, E3} -> (fun (V9, V10) -> {'Idris.Builtin.MkPair', [V3 | V7], {'Idris.Builtin.MkPair', [V4 | V9], [V5 | V10]}} end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--unzipWith3-2573'(V0, V1, V2, V3) -> case V3 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V4, V5) -> case V5 of {'Idris.Builtin.MkPair', E2, E3} -> (fun (V6, V7) -> case ('dn--un--unzipWith3_Zippable_List'(V2, V1)) of {'Idris.Builtin.MkPair', E4, E5} -> (fun (V8, V9) -> case V9 of {'Idris.Builtin.MkPair', E6, E7} -> (fun (V10, V11) -> {'Idris.Builtin.MkPair', [V4 | V8], {'Idris.Builtin.MkPair', [V6 | V10], [V7 | V11]}} end(E6, E7)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E4, E5)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--case block in unzipWith-2502'(V0, V1, V2, V3, V4, V5) -> case V5 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V6, V7) -> {'Idris.Builtin.MkPair', [V3 | V6], [V4 | V7]} end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'case--replaceWhen-2024'(V0, V1, V2, V3, V4) -> case V4 of 1 -> V0; 0 -> V3; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--tails-1979'(V0) -> case V0 of [] -> []; [E0 | E1] -> (fun (V1, V2) -> ('un--tails'(V2)) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--inits-1950'(V0) -> case V0 of [] -> []; [E0 | E1] -> (fun (V1, V2) -> ('Idris.Idris2.Prelude.Types':'dn--un--map_Functor_List'(fun (V3) -> [V1 | V3] end, ('un--inits'(V2)))) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--case block in partition-1897'(V0, V1, V2, V3, V4, V5) -> case V5 of 1 -> {'Idris.Builtin.MkPair', [V2 | V3], V4}; 0 -> {'Idris.Builtin.MkPair', V3, [V2 | V4]}; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--partition-1879'(V0, V1, V2, V3) -> case V3 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V4, V5) -> case (V2(V0)) of 1 -> {'Idris.Builtin.MkPair', [V0 | V4], V5}; 0 -> {'Idris.Builtin.MkPair', V4, [V0 | V5]}; _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--splitAt-1833'(V0, V1, V2, V3) -> case V3 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V4, V5) -> {'Idris.Builtin.MkPair', [V1 | V4], V5} end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--split-1767'(V0, V1, V2) -> case V2 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V3, V4) -> case V4 of [] -> ('Idris.Idris2.Data.List1':'un--singleton'(V3)); [E2 | E3] -> (fun (V5, V6) -> {'Idris.Data.List1.:::', V3, ('Idris.Idris2.Data.List1':'un--forget'(('un--split'(V1, V6))))} end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--case block in span-1703'(V0, V1, V2, V3) -> case V3 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V4, V5) -> {'Idris.Builtin.MkPair', [V2 | V4], V5} end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--span-1686'(V0, V1, V2, V3) -> case V3 of 1 -> case ('un--span'(V2, V1)) of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V4, V5) -> {'Idris.Builtin.MkPair', [V0 | V4], V5} end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end; 0 -> {'Idris.Builtin.MkPair', [], [V0 | V1]}; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--case block in spanBy-1637'(V0, V1, V2, V3, V4) -> case V4 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V5, V6) -> {'Idris.Builtin.MkPair', [V3 | V5], V6} end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--spanBy-1594'(V0, V1, V2, V3) -> case V3 of {'Idris.Prelude.Types.Nothing'} -> (fun () -> {'Idris.Builtin.MkPair', [], [V0 | V1]} end()); {'Idris.Prelude.Types.Just', E0} -> (fun (V4) -> case ('un--spanBy'(V2, V1)) of {'Idris.Builtin.MkPair', E1, E2} -> (fun (V5, V6) -> {'Idris.Builtin.MkPair', [V4 | V5], V6} end(E1, E2)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--deleteBy-1442'(V0, V1, V2, V3, V4) -> case V4 of 1 -> V2; 0 -> [V1 | ('un--deleteBy'(V3, V0, V2))]; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--nubBy,nubBy\x{27}-1371'(V0, V1, V2, V3, V4) -> case V4 of 1 -> ('nested--3900-1352--in--un--nubBy\x{27}'(V3, V2, V1)); 0 -> [V0 | ('nested--3900-1352--in--un--nubBy\x{27}'([V0 | V3], V2, V1))]; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'case--findIndices,h-1201'(V0, V1, V2, V3, V4) -> case V4 of 1 -> [V3 | ('nested--3737-1188--in--un--h'(V0, (1 + V3), V2))]; 0 -> ('nested--3737-1188--in--un--h'(V0, (1 + V3), V2)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'nested--6096-3513--in--un--spreadHeads'(V0, V1, V2, V3) -> case V2 of [] -> V3; [E0 | E1] -> (fun (V4, V5) -> case V3 of [] -> [[V4 | []] | ('nested--6096-3513--in--un--spreadHeads'(V0, V1, V5, []))]; [E2 | E3] -> (fun (V6, V7) -> [[V4 | V6] | ('nested--6096-3513--in--un--spreadHeads'(V0, V1, V5, V7))] end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'nested--5925-3336--in--un--splitRec'(V0, V1, V2, V3, V4) -> case V2 of [E0 | E1] -> (fun (V5, V6) -> case V6 of [E2 | E3] -> (fun (V7, V8) -> case V3 of [E4 | E5] -> (fun (V9, V10) -> ('nested--5925-3336--in--un--splitRec'(V0, V1, V8, V10, fun (V11) -> (V4([V9 | V11])) end)) end(E4, E5)); _ -> {'Idris.Builtin.MkPair', V3, (V4([]))} end end(E2, E3)); _ -> {'Idris.Builtin.MkPair', V3, (V4([]))} end end(E0, E1)); _ -> {'Idris.Builtin.MkPair', V3, (V4([]))} end.
'nested--5925-3337--in--un--split'(V0, V1, V2) -> ('nested--5925-3336--in--un--splitRec'(V0, V1, V2, V2, fun (V3) -> V3 end)).
'nested--3900-1352--in--un--nubBy\x{27}'(V0, V1, V2) -> case V2 of [] -> []; [E0 | E1] -> (fun (V3, V4) -> case ('un--elemBy'(V1, V3, V0)) of 1 -> ('nested--3900-1352--in--un--nubBy\x{27}'(V0, V1, V4)); 0 -> [V3 | ('nested--3900-1352--in--un--nubBy\x{27}'([V3 | V0], V1, V4))]; _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'nested--3737-1188--in--un--h'(V0, V1, V2) -> case V2 of [] -> []; [E0 | E1] -> (fun (V3, V4) -> case (V0(V3)) of 1 -> [V1 | ('nested--3737-1188--in--un--h'(V0, (1 + V1), V4))]; 0 -> ('nested--3737-1188--in--un--h'(V0, (1 + V1), V4)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'nested--6140-3558--in--un--go'(V0, V1, V2, V3, V4) -> case V4 of [] -> {'Idris.Builtin.MkPair', ('Idris.Idris2.Data.List1':'un--singleton'(V3)), []}; [E0 | E1] -> (fun (V5, V6) -> case ('nested--6140-3558--in--un--go'(V0, V1, V2, V5, V6)) of {'Idris.Builtin.MkPair', E2, E3} -> (fun (V7, V8) -> case ((V2(V3))(V5)) of 1 -> {'Idris.Builtin.MkPair', ('Idris.Idris2.Data.List1':'un--cons'(V3, V7)), V8}; 0 -> {'Idris.Builtin.MkPair', ('Idris.Idris2.Data.List1':'un--singleton'(V3)), [V7 | V8]}; _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'un--transpose'(V0) -> case V0 of [] -> []; [E0 | E1] -> (fun (V1, V2) -> ('nested--6096-3513--in--un--spreadHeads'(V1, V2, V1, ('un--transpose'(V2)))) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'un--sortBy'(V0, V1) -> case V1 of [] -> []; [E2 | E3] -> (fun (V2, V3) -> case V3 of [] -> [V2 | []]; _ -> case ('nested--5925-3337--in--un--split'(V1, V0, V1)) of {'Idris.Builtin.MkPair', E4, E5} -> (fun (V4, V5) -> ('un--mergeBy'(V0, ('un--sortBy'(V0, V4)), ('un--sortBy'(V0, V5)))) end(E4, E5)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end end(E2, E3)); _ -> case ('nested--5925-3337--in--un--split'(V1, V0, V1)) of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V6, V7) -> ('un--mergeBy'(V0, ('un--sortBy'(V0, V6)), ('un--sortBy'(V0, V7)))) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end.
...
'un--reverseReverseOnto'(V0, V1) -> case V1 of [] -> 0; [E0 | E1] -> (fun (V2, V3) -> ('un--reverseReverseOnto'([V2 | V0], V3)) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'un--nubBy'(V0, V1) -> ('nested--3900-1352--in--un--nubBy\x{27}'([], V0, V1)).
...
'un--groupBy'(V0, V1) -> case V1 of [] -> []; [E0 | E1] -> (fun (V2, V3) -> case ('nested--6140-3558--in--un--go'(V2, V3, V0, V2, V3)) of {'Idris.Builtin.MkPair', E2, E3} -> (fun (V4, V5) -> [V4 | V5] end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'un--findIndices'(V0, V1) -> ('nested--3737-1188--in--un--h'(V0, 0, V1)).
