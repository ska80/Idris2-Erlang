...
'dn--un--preorderTrans_Preorder_ZeroOneOmega'(V0, V1, V2, V3, V4) -> case V0 of 0 -> 0; 1 -> case V1 of 1 -> V4; 2 -> case V2 of 1 -> 0; 2 -> 0; _ -> ('erlang':'throw'("Error: Unreachable branch")) end; _ -> ('erlang':'throw'("Error: Unreachable branch")) end; 2 -> case V1 of 2 -> V4; _ -> ('erlang':'throw'("Error: Unreachable branch")) end; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
