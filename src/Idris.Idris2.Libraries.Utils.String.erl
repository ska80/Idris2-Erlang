...
-export([
  'nested--2476-418--in--un--escape'/4,
  'un--stripSurrounds'/3,
  'un--stripQuotes'/1,
  'un--lowerFirst'/1,
...
'un--escapeGeneric'(V0, V1, V2) -> ('Idris.Idris2.Prelude.Types':'un--fastPack'(('Idris.Idris2.Prelude.Types':'dn--un--foldr_Foldable_List'(fun (V3) -> fun (V4) -> ('nested--2476-418--in--un--escape'(V1, V0, V3, V4)) end end, [], ('Idris.Idris2.Prelude.Types':'un--fastUnpack'(V2)))))).
