...
'un--unlines\x{27}'(V0) -> case V0 of [] -> []; [E0 | E1] -> (fun (V1, V2) -> case V2 of [] -> V1; _ -> ('Idris.Idris2.Prelude.Types.List':'un--tailRecAppend'(V1, [$\x{a} | ('un--unlines\x{27}'(V2))])) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
