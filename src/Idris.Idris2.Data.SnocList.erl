...
-export([
  ...
  'case--max-793'/4,
  'case--min-765'/4,
  'nested--3498-1005--in--un--show\x{27}'/4,
  'nested--3644-1222--in--un--h'/4,
...
'nested--3498-1005--in--un--show\x{27}'(V0, V1, V2, V3) -> case V3 of {'Idris.Prelude.Basics.Lin'} -> (fun () -> V2 end()); {'Idris.Prelude.Basics.:<', E0, E1} -> (fun (V4, V5) -> ('nested--3498-1005--in--un--show\x{27}'(V0, V1, [case V0 of {'Idris.Prelude.Show.MkShow', E2, E3} -> (fun (V6, V7) -> (V6(V5)) end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end | V2], V4)) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'nested--3644-1222--in--un--h'(V0, V1, V2, V3) -> case V3 of {'Idris.Prelude.Basics.Lin'} -> (fun () -> V1 end()); {'Idris.Prelude.Basics.:<', E0, E1} -> (fun (V4, V5) -> ((V2(('nested--3644-1222--in--un--h'(V0, V1, V2, V4))))(V5)) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'dn--un--foldl_Foldable_SnocList'(V0, V1, V2) -> ('nested--3644-1222--in--un--h'(V2, V1, V0, V2)).
...
'un--asList'(V0) -> ('Idris.Idris2.Prelude.Types.List':'un--reverse'(('dn--un--cast_Cast_(SnocList $a)_(List $a)'(V0)))).
