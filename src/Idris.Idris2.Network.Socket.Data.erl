...
-export([
  'nested--3310-4108--in--un--toInt\x{27}'/2,
  'nested--3310-4109--in--un--toInt'/2,
  'nested--3310-4110--in--un--splitted'/1,
...
'nested--3310-4108--in--un--toInt\x{27}'(V0, V1) -> ('Idris.Idris2.Prelude.Cast':'dn--un--cast_Cast_String_Integer'(V1)).
'nested--3310-4109--in--un--toInt'(V0, V1) -> ('nested--3310-4108--in--un--toInt\x{27}'(V0, V1)).
'nested--3310-4110--in--un--splitted'(V0) -> ('Idris.Idris2.Data.List1':'dn--un--map_Functor_List1'(fun (V1) -> ('nested--3310-4109--in--un--toInt'(V0, V1)) end, ('Idris.Idris2.Data.String':'un--split'(fun (V2) -> ('Idris.Idris2.Prelude.EqOrd':'dn--un--==_Eq_Char'(V2, $.)) end, V0)))).
