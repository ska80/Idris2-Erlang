...
-export([
  ...
  'case--unzip3-2832'/2,
  'case--unfoldr-2505'/3,
  'nested--3724-3272--in--un--quadrant'/0,
  'nested--3627-3187--in--un--cycle\x{27}'/3,
...
'nested--3724-3272--in--un--quadrant'() -> ('Idris.Idris2.Prelude.Types':'dn--un--map_Functor_Stream'(fun (V0) -> ('Idris.Idris2.Prelude.Types':'dn--un--map_Functor_Stream'(fun (V1) -> {'Idris.Builtin.MkPair', V0, V1} end, ('un--nats'()))) end, ('un--nats'()))).
'nested--3627-3187--in--un--cycle\x{27}'(V0, V1, V2) -> case V2 of [] -> {'Idris.Prelude.Types.Stream.::', V0, fun () -> ('nested--3627-3187--in--un--cycle\x{27}'(V0, V1, V1)) end}; [E0 | E1] -> (fun (V3, V4) -> {'Idris.Prelude.Types.Stream.::', V3, fun () -> ('nested--3627-3187--in--un--cycle\x{27}'(V0, V1, V4)) end} end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'un--cycle'(V0) -> case V0 of [E0 | E1] -> (fun (V1, V2) -> {'Idris.Prelude.Types.Stream.::', V1, fun () -> ('nested--3627-3187--in--un--cycle\x{27}'(V1, V2, V2)) end} end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
