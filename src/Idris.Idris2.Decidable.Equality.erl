...
-export([
  ...
  'case--decEq-1545'/3,
  'case--decEq-1474'/3,
  'nested--4470-1648--in--un--primitiveNotEq'/3,
  'nested--4392-1577--in--un--primitiveNotEq'/3,
  'nested--4314-1506--in--un--primitiveNotEq'/3,
  'nested--4236-1435--in--un--primitiveNotEq'/3,
  'nested--4470-1647--in--un--primitiveEq'/2,
  'nested--4392-1576--in--un--primitiveEq'/2,
  'nested--4314-1505--in--un--primitiveEq'/2,
  'nested--4236-1434--in--un--primitiveEq'/2,
...
'case--decEq-1687'(V0, V1, V2) -> case V2 of 1 -> {'Idris.Prelude.Types.Yes', ('nested--4470-1647--in--un--primitiveEq'(V0, V1))}; 0 -> {'Idris.Prelude.Types.No', fun (V3) -> ('nested--4470-1648--in--un--primitiveNotEq'(V0, V1, V3)) end}; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--decEq-1616'(V0, V1, V2) -> case V2 of 1 -> {'Idris.Prelude.Types.Yes', ('nested--4392-1576--in--un--primitiveEq'(V0, V1))}; 0 -> {'Idris.Prelude.Types.No', fun (V3) -> ('nested--4392-1577--in--un--primitiveNotEq'(V0, V1, V3)) end}; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--decEq-1545'(V0, V1, V2) -> case V2 of 1 -> {'Idris.Prelude.Types.Yes', ('nested--4314-1505--in--un--primitiveEq'(V0, V1))}; 0 -> {'Idris.Prelude.Types.No', fun (V3) -> ('nested--4314-1506--in--un--primitiveNotEq'(V0, V1, V3)) end}; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--decEq-1474'(V0, V1, V2) -> case V2 of 1 -> {'Idris.Prelude.Types.Yes', ('nested--4236-1434--in--un--primitiveEq'(V0, V1))}; 0 -> {'Idris.Prelude.Types.No', fun (V3) -> ('nested--4236-1435--in--un--primitiveNotEq'(V0, V1, V3)) end}; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'nested--4470-1648--in--un--primitiveNotEq'(V0, V1, V2) -> ('Idris.Idris2.Builtin':'un--believe_me'(0)).
'nested--4392-1577--in--un--primitiveNotEq'(V0, V1, V2) -> ('Idris.Idris2.Builtin':'un--believe_me'(0)).
'nested--4314-1506--in--un--primitiveNotEq'(V0, V1, V2) -> ('Idris.Idris2.Builtin':'un--believe_me'(0)).
'nested--4236-1435--in--un--primitiveNotEq'(V0, V1, V2) -> ('Idris.Idris2.Builtin':'un--believe_me'(0)).
'nested--4470-1647--in--un--primitiveEq'(V0, V1) -> ('Idris.Idris2.Builtin':'un--believe_me'(0)).
'nested--4392-1576--in--un--primitiveEq'(V0, V1) -> ('Idris.Idris2.Builtin':'un--believe_me'(0)).
'nested--4314-1505--in--un--primitiveEq'(V0, V1) -> ('Idris.Idris2.Builtin':'un--believe_me'(0)).
'nested--4236-1434--in--un--primitiveEq'(V0, V1) -> ('Idris.Idris2.Builtin':'un--believe_me'(0)).
'dn--un--decEq_DecEq_String'(V0, V1) -> case ('Idris.Idris2.Prelude.EqOrd':'dn--un--==_Eq_String'(V0, V1)) of 1 -> {'Idris.Prelude.Types.Yes', ('nested--4470-1647--in--un--primitiveEq'(V1, V0))}; 0 -> {'Idris.Prelude.Types.No', fun (V2) -> ('nested--4470-1648--in--un--primitiveNotEq'(V1, V0, V2)) end}; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'dn--un--decEq_DecEq_Integer'(V0, V1) -> case ('Idris.Idris2.Prelude.EqOrd':'dn--un--==_Eq_Integer'(V0, V1)) of 1 -> {'Idris.Prelude.Types.Yes', ('nested--4392-1576--in--un--primitiveEq'(V1, V0))}; 0 -> {'Idris.Prelude.Types.No', fun (V2) -> ('nested--4392-1577--in--un--primitiveNotEq'(V1, V0, V2)) end}; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'dn--un--decEq_DecEq_Int'(V0, V1) -> case ('Idris.Idris2.Prelude.EqOrd':'dn--un--==_Eq_Int'(V0, V1)) of 1 -> {'Idris.Prelude.Types.Yes', ('nested--4236-1434--in--un--primitiveEq'(V1, V0))}; 0 -> {'Idris.Prelude.Types.No', fun (V2) -> ('nested--4236-1435--in--un--primitiveNotEq'(V1, V0, V2)) end}; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'dn--un--decEq_DecEq_Char'(V0, V1) -> case ('Idris.Idris2.Prelude.EqOrd':'dn--un--==_Eq_Char'(V0, V1)) of 1 -> {'Idris.Prelude.Types.Yes', ('nested--4314-1505--in--un--primitiveEq'(V1, V0))}; 0 -> {'Idris.Prelude.Types.No', fun (V2) -> ('nested--4314-1506--in--un--primitiveNotEq'(V1, V0, V2)) end}; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
