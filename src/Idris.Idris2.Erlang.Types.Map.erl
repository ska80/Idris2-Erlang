...
'un--lookup'(V0, V1, V2, V3) -> ('Idris.Idris2.Erlang.Decode':'un--erlDecodeMay'({'Idris.Erlang.Types.ETErlMapSubset', {'Idris.Erlang.Types.EMTNil'}}, fun (V4) -> ('Idris.Idris2.Erlang.Decode':'un--mapEntry'(V1, V2, V4)) end, ('Idris.Idris2.Builtin':'un--believe_me'(V3)))).
