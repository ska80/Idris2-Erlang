...
-export([
  'nested--6541-2839--in--un--genHalt'/5,
  'nested--6443-2748--in--un--curry'/10,
  'un--newLocalVars'/2,
  'un--newLocalVar'/2,
  'un--integerPower'/2,
  'un--genValidChar'/2,
...
'nested--6541-2839--in--un--genHalt'(V0, V1, V2, V3, V4) -> ('un--genFunCall'(V3, <<"erlang"/utf8>>, <<"halt"/utf8>>, [{'Idris.Compiler.Erlang.IR.ErlExpr.EInteger', V3, V4} | []])).
'nested--6443-2748--in--un--curry'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9) -> case V6 of 0 -> fun (V10) -> {'Idris.Prelude.Types.Right', (V7({'Idris.Compiler.Erlang.IR.ErlExpr.EApp', V5, V8, ('Idris.Idris2.Prelude.Types.List':'un--reverse'(V9))}))} end; _ -> begin (V11 = (V6 - 1)), fun (V12) -> begin (V13 = ('un--newLocalVar'(V4, V12))), case V13 of {'Idris.Prelude.Types.Left', E0} -> (fun (V14) -> {'Idris.Prelude.Types.Left', V14} end(E0)); {'Idris.Prelude.Types.Right', E1} -> (fun (V15) -> begin (V16 = (('nested--6443-2748--in--un--curry'(V0, V1, V2, V3, V4, V5, V11, V7, V8, [{'Idris.Compiler.Erlang.IR.ErlExpr.ELocal', V5, V15} | V9]))(V12))), case V16 of {'Idris.Prelude.Types.Left', E2} -> (fun (V17) -> {'Idris.Prelude.Types.Left', V17} end(E2)); {'Idris.Prelude.Types.Right', E3} -> (fun (V18) -> {'Idris.Prelude.Types.Right', {'Idris.Compiler.Erlang.IR.ErlExpr.ELam', V5, [V15 | []], V18}} end(E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end end(E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end end end end.
...
'un--genUnsafePerformIO'(V0, V1, V2) -> {'Idris.Compiler.Erlang.IR.ErlExpr.EApp', V1, ('un--genRef'(V0, V1, {'Idris.Core.Name.NS', ('Idris.Idris2.Core.Name.Namespace':'un--primIONS'()), {'Idris.Core.Name.UN', {'Idris.Core.Name.Basic', <<"unsafePerformIO"/utf8>>}}})), [V2 | []]}.
...
'un--genRight'(V0, V1) -> {'Idris.Compiler.Erlang.IR.ErlExpr.ECon', V0, ('Idris.Idris2.Compiler.Erlang.Name':'un--constructorName'({'Idris.Core.Name.NS', ('Idris.Idris2.Core.Name.Namespace':'un--typesNS'()), {'Idris.Core.Name.UN', {'Idris.Core.Name.Basic', <<"Right"/utf8>>}}})), [V1 | []]}.
...
'un--genNothing'(V0) -> {'Idris.Compiler.Erlang.IR.ErlExpr.ECon', V0, ('Idris.Idris2.Compiler.Erlang.Name':'un--constructorName'({'Idris.Core.Name.NS', ('Idris.Idris2.Core.Name.Namespace':'un--typesNS'()), {'Idris.Core.Name.UN', {'Idris.Core.Name.Basic', <<"Nothing"/utf8>>}}})), []}.
...
'un--genMkUnit'(V0) -> {'Idris.Compiler.Erlang.IR.ErlExpr.ECon', V0, ('Idris.Idris2.Compiler.Erlang.Name':'un--constructorName'({'Idris.Core.Name.NS', ('Idris.Idris2.Core.Name.Namespace':'un--builtinNS'()), {'Idris.Core.Name.UN', {'Idris.Core.Name.Basic', <<"MkUnit"/utf8>>}}})), []}.
...
'un--genLeft'(V0, V1) -> {'Idris.Compiler.Erlang.IR.ErlExpr.ECon', V0, ('Idris.Idris2.Compiler.Erlang.Name':'un--constructorName'({'Idris.Core.Name.NS', ('Idris.Idris2.Core.Name.Namespace':'un--typesNS'()), {'Idris.Core.Name.UN', {'Idris.Core.Name.Basic', <<"Left"/utf8>>}}})), [V1 | []]}.
'un--genJust'(V0, V1) -> {'Idris.Compiler.Erlang.IR.ErlExpr.ECon', V0, ('Idris.Idris2.Compiler.Erlang.Name':'un--constructorName'({'Idris.Core.Name.NS', ('Idris.Idris2.Core.Name.Namespace':'un--typesNS'()), {'Idris.Core.Name.UN', {'Idris.Core.Name.Basic', <<"Just"/utf8>>}}})), [V1 | []]}.
...
'un--genCurry'(V0, V1, V2, V3, V4) -> ('nested--6443-2748--in--un--curry'(V4, V3, V2, V1, V0, V1, V2, V3, V4, [])).
