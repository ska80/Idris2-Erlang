...
-export([
  'case--guard-1103'/2,
  'nested--2467-1646--in--un--monoid'/1,
...
'case--guard-1103'(V0, V1) -> case V1 of 1 -> case V0 of {'Idris.Prelude.Interfaces.MkAlternative', E0, E1, E2} -> (fun (V2, V3, V4) -> case V2 of {'Idris.Prelude.Interfaces.MkApplicative', E3, E4, E5} -> (fun (V5, V6, V7) -> ((V6('erased'))(0)) end(E3, E4, E5)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1, E2)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end; 0 -> case V0 of {'Idris.Prelude.Interfaces.MkAlternative', E6, E7, E8} -> (fun (V8, V9, V10) -> (V9('erased')) end(E6, E7, E8)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'nested--2467-1646--in--un--monoid'(V0) -> {'Idris.Prelude.Interfaces.MkMonoid', fun (V1) -> fun (V2) -> case V1 of 1 -> V2; 0 -> 0; _ -> ('erlang':'throw'("Error: Unreachable branch")) end end end, 1}.
...
'dn--un--neutral_Monoid_(|Unit,MkUnit|)'() -> 0.
'dn--un--neutral_Monoid_(|((Builtin.Pair $a) $b),((Builtin.MkPair $a) $b)|)'(V0, V1) -> {'Idris.Builtin.MkPair', case V0 of {'Idris.Prelude.Interfaces.MkMonoid', E0, E1} -> (fun (V2, V3) -> V3 end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end, case V1 of {'Idris.Prelude.Interfaces.MkMonoid', E2, E3} -> (fun (V4, V5) -> V5 end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end}.
...
'dn--un--__Impl_Monoid_(|((Builtin.Pair $a) $b),((Builtin.MkPair $a) $b)|)'(V0, V1) -> {'Idris.Prelude.Interfaces.MkMonoid', fun (V2) -> fun (V3) -> ('dn--un--<+>_Semigroup_(|((Builtin.Pair $a) $b),((Builtin.MkPair $a) $b)|)'(case V0 of {'Idris.Prelude.Interfaces.MkMonoid', E0, E1} -> (fun (V4, V5) -> V4 end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end, case V1 of {'Idris.Prelude.Interfaces.MkMonoid', E2, E3} -> (fun (V6, V7) -> V6 end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end, V2, V3)) end end, ('dn--un--neutral_Monoid_(|((Builtin.Pair $a) $b),((Builtin.MkPair $a) $b)|)'(V0, V1))}.
...
'dn--un--<+>_Semigroup_(|((Builtin.Pair $a) $b),((Builtin.MkPair $a) $b)|)'(V0, V1, V2, V3) -> case V2 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V4, V5) -> case V3 of {'Idris.Builtin.MkPair', E2, E3} -> (fun (V6, V7) -> {'Idris.Builtin.MkPair', ((V0(V4))(V6)), ((V1(V5))(V7))} end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
